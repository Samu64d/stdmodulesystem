#
# collections:referenced_list/update_on_match/loop
#
...
data modify storage io: stack_element_ref set value "io: list_ref"
...
execute if score ::inout match_success = ::const TRUE run function collections:referenced_list/update_on_match/on_match_success
...
execute if score ::collections::referenced_list index < ::collections::referenced_list length run function collections:referenced_list/update_on_match/loop with storage io:
