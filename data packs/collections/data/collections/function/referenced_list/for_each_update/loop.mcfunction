#
# collections:referenced_list/for_each_update/loop
#
...
execute if score ::collections::referenced_list index < ::collections::referenced_list length run function collections:referenced_list/for_each_update/loop with storage io:
