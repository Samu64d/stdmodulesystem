#
# collections:iterable_map/for_each_key/loop
#
...
function collections:iterable_map/for_each_key/get_key_prev_key with storage io:
...
execute if data storage io: prev_key run function collections:iterable_map/for_each_key/update_current_key with storage io:

execute if data storage collections:volatile iterable_map.current_key run function collections:iterable_map/for_each_key/loop with storage io:
