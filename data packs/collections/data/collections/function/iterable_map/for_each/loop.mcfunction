...
data modify storage io: stack_element_ref set value "io: iterable_map"
...
# Push the element onto the stack
data modify storage io: stack_element_ref set value "collections:volatile iterable_map.current_key"
function stdmodulesystem:stack/push
