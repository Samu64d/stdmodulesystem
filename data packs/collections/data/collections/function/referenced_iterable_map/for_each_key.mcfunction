#
# collections:referenced_iterable_map/for_each_key
#
# Iterate throuth the keys of an iterable map
#> Storage
...
function collections:referenced_iterable_map/for_each_key/loop with storage io:
