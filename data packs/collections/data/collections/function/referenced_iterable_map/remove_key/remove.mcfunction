...
$execute if data storage $(iterable_map_ref).data.'$(key)'.prev_key run data modify storage io: prev_key set from storage $(iterable_map_ref).data.'$(key)'.prev_key
$execute if data storage $(iterable_map_ref).data.'$(key)'.next_key run data modify storage io: next_key set from storage $(iterable_map_ref).data.'$(key)'.next_key
...
# Remove value
$data remove storage $(iterable_map_ref).data.'$(key)'
