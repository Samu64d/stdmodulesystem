#
# collections:list/remove_on_match/loop
#
...
execute if score ::inout match_success = ::const TRUE run function collections:list/remove_on_match/on_match_success

# Check for list limit
scoreboard players remove ::collections::list index 1
execute if score ::collections::list index matches 0.. run function collections:list/remove_on_match/loop with storage io:
