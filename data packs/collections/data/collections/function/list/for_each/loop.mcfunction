#
# collections:list/for_each/loop
#
...
execute if score ::collections::list index < ::collections::list length run function collections:list/for_each/loop with storage io:
