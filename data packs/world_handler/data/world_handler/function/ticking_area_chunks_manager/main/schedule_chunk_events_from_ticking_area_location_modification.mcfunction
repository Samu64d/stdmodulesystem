...
function world_handler:ticking_areas_manager/ticking_area_descriptor/get_border_bounding_box
...
data modify storage io: list_ref set value "io: chunk_list"
data modify storage io: callback set value "world_handler:ticking_area_chunks_manager/main/schedule_chunk_events_from_ticking_area_location_modification/callback_border_creation"
...
# Iterate through the chunk list
data modify storage io: list_ref set value "io: chunk_list"
data modify storage io: callback set value "world_handler:ticking_area_chunks_manager/main/schedule_chunk_events_from_ticking_area_location_modification/callback_border_destruction"
function collections:referenced_list/for_each
