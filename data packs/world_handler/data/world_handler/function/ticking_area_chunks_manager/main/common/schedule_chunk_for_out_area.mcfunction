#
# world_handler:ticking_area_chunks_manager/main/common/schedule_chunk_for_out_area
#

# Create chunk event descriptor
scoreboard players operation ::in event = ::world_handler::ticking_area_chunks_manager::enum_chunk_events OUT_AREA
