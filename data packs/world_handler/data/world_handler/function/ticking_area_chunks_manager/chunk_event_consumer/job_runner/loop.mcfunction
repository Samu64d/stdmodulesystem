...
# Chunk entered ticking area border
execute if score ::world_handler::ticking_area_chunks_manager event = ::world_handler::ticking_area_chunks_manager::enum_chunk_events IN_AREA_BORDER run function world_handler:events/emitters/on_chunk_entered_ticking_areas_border
...
# Chunk exited ticking area border
execute if score ::world_handler::ticking_area_chunks_manager event = ::world_handler::ticking_area_chunks_manager::enum_chunk_events OUT_AREA_BORDER run function world_handler:events/emitters/on_chunk_exited_ticking_areas_border
