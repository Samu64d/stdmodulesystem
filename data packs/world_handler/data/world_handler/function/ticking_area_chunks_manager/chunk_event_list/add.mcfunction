...
data modify storage io: list_ref set value "world_handler:data ticking_area_chunks_manager.chunk_event_list"
data modify storage io: element_ref set value "io: chunk_event_descriptor"
