...
data modify storage io: list0_ref set value "io: chunk_list"
data modify storage io: list1_ref set value "world_handler:volatile ticking_areas_manager.temp_chunk_list"
