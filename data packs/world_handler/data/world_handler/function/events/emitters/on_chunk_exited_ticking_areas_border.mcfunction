#
# world_handler:events/emitters/on_chunk_exited_ticking_areas_border
#
...
# Fire
data modify storage io: name set value "world_handler:on_chunk_exited_ticking_areas_border"
