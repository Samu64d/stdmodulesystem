...
execute if score ::world_handler::chunk_manager status = ::world_handler::chunk_manager::enum_loaded_chunk_status UNKNOW_LOADED run function world_handler:chunk_manager/main/process_loaded_chunk/on_wait_unload_check_success_unknow_loaded
