...
# Loaded chunk
execute if score ::world_handler::chunk_manager temp0 = ::const TRUE run function world_handler:chunk_manager/main/on_chunk_exited_ticking_areas/on_wait_load_check_success_check_success
