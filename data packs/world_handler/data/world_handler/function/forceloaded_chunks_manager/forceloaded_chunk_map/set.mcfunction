...
data modify storage io: iterable_map_ref set value "world_handler:data forceloaded_chunks_manager.forceloaded_chunk_map"
...
data modify storage io: value_ref set value "io: forceloaded_chunk_descriptor"
