...
data modify storage io: list_ref set value "data_observer:data observed_data_list"
data modify storage io: like_element set value {}
data modify storage io: like_element.path set from storage io: path
data modify storage io: element_ref set value "io: observed_data_descriptor"
