...
data modify storage io: list_ref set value "world_loader:volatile players_manager.handled_player_list"
data modify storage io: element_ref set value "io: handled_player_descriptor"
