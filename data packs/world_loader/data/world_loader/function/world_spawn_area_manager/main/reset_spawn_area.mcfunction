#
# world_loader:world_spawn_area_manager/main/reset_spawn_area
#
...
data modify storage io: ticking_area_uuid set value [I; 0, 0, 0, 0]
function world_loader:world_spawn_area_manager/world_spawn_area_descriptor/set_ticking_area
scoreboard players operation ::in active = ::const FALSE
