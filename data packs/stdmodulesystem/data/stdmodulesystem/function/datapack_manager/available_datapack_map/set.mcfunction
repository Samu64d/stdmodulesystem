...
data modify storage io: map_ref set value "stdmodulesystem:volatile datapack_manager.available_datapack_map"
data modify storage io: key set from storage io: datapack_id
data modify storage io: value_ref set value "io: available_datapack"
