...
data modify storage io: list_ref set value "stdmodulesystem:volatile datapack_manager.available_datapack_list"
function stdmodulesystem:datapack_manager/available_datapack/get_datapack_id
data modify storage io: element_ref set value "io: datapack_id"
