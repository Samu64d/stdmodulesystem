...
function stdmodulesystem:obj/obj_runtime/define/define
function stdmodulesystem:obj/objs/obj/define/define
function stdmodulesystem:obj/objs/obj.controlled_entity.display.text_display/define/define
