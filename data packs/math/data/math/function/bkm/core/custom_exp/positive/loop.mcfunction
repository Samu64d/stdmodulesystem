#
# math:bkm/core/custom_exp/positive/loop
#
...
execute if score ::math::bkm x >= ::math::bkm e run function math:bkm/core/custom_exp/positive/mul_2i
...
execute if score ::math::bkm i matches ..4 if score ::math::bkm i < ::math::bkm::const BKM_EXP_ITERATIONS run function math:bkm/core/custom_exp/positive/loop
