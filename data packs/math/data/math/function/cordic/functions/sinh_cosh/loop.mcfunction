#
# math:cordic/functions/sinh_cosh/loop
#

# Get the direction sign
function math:cordic/directions/rotation
...
# Execute
execute if score ::math::cordic need_double = ::const FALSE run function math:cordic/functions/sinh_cosh/single_iteration
execute if score ::math::cordic need_double = ::const TRUE run function math:cordic/functions/sinh_cosh/double_iteration

# Update loop variable
scoreboard players operation ::math::cordic pow *= ::int 2

scoreboard players add ::math::cordic i 1
execute if score ::math::cordic i <= ::math::cordic::const CRDC_ITERATIONS run function math:cordic/functions/sinh_cosh/loop
