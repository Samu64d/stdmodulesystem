...
# math:tanh
#
# Get the hyperbolic tangent value of a given angle in radians with fixed point precision
#> Scores
...
# Calculate sinh
execute store result score ::math sinh run function math:sinh
...
# Calculate cosh
execute store result score ::in value1 run function math:cosh

# Calculate
scoreboard players operation ::in value0 = ::math sinh
execute store result score ::math tanh run function math:div
