...
execute store result score ::in temp0 run function math:mulf
...
execute store result score ::in value1 run function math:sqrtf
scoreboard players operation ::in value0 = ::in x
execute store result score ::in t run function math:divf

# Computer arccosine
execute store result score ::math atan2 run function math:acosf
