...
# math:cosh
#
# Get the hyperbolic cosine value of a given angle in radians with fixed point precision
#> Scores
...
# In range
execute if score ::math is_in_range = ::const TRUE run function math:cosh/in_range

# Out range
execute if score ::math is_in_range = ::const FALSE run function math:cosh/out_range
