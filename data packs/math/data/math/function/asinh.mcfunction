...
# math:asinh
#
# Get the hyperbolic arcsine value of a given ratio with fixed point precision
#> Scores
...
# In range
execute if score ::math is_in_range = ::const TRUE run function math:asinh/in_range

# Out range
execute if score ::math is_in_range = ::const FALSE run function math:asinh/out_range
