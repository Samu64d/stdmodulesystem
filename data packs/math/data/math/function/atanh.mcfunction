...
# math:atanh
#
# Get the hyperbolic arctangent value of a given ratio with fixed point precision
#> Scores
...
# In range
execute if score ::math is_in_range = ::const TRUE run function math:atanh/in_range

# Out range
execute if score ::math is_in_range = ::const FALSE run function math:atanh/out_range
