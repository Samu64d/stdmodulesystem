...
# Calculate exp(x - [x])
execute store result score ::math x_int run function math:get_integer_partf
...
# Calculate exp([x])
execute store result score ::math x_fract run function math:get_fractional_partf
