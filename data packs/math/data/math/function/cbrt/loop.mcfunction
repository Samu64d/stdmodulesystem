...
execute store result score ::in value1 run function math:mul
...
execute store result score ::math cbrt run function math:div

scoreboard players operation ::math prev_cbrt -= ::math cbrt
execute unless score ::math prev_cbrt matches -1..1 run function math:cbrt/loop
