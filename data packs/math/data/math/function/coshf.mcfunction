...
# math:coshf
#
# Get the hyperbolic cosine value of a given angle in radians with arbitrary floating point precision
#> Scores
...
# In range
execute if score ::math is_in_range = ::const TRUE run function math:coshf/in_range

# Out range
execute if score ::math is_in_range = ::const FALSE run function math:coshf/out_range

# Return data
return run scoreboard players get ::math cosh
