...
# First nine digits of pi expressed in radians
scoreboard objectives add PI dummy

# First nine digits of 1/2pi expressed in radians
scoreboard objectives add 1_PI_2 dummy

# First nine digits of 2pi number expressed in radians
scoreboard objectives add 2_PI dummy

scoreboard objectives add PI_SIZE dummy

# First eight digits of pi expressed in degrees
scoreboard objectives add PI_DEG dummy

# First nine digits of 1/2pi in degrees
scoreboard objectives add 1_PI_2_DEG dummy

# First nine digits of 2pi number in degrees
...
# Default value of pi expressed in radians
scoreboard objectives add FXP_PI dummy

# Default value of digits of 1/2pi expressed in radians
scoreboard objectives add FXP_1_PI_2 dummy

# Default value of digits of 2pi number expressed in radians
scoreboard objectives add FXP_2_PI dummy

# Default value of digits of pi expressed in degrees
scoreboard objectives add FXP_PI_DEG dummy

# Default value of digits of 1/2pi in degrees
scoreboard objectives add FXP_1_PI_2_DEG dummy

# Default value of digits of 2pi number in degrees
