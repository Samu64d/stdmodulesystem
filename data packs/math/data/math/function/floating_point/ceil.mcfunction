#
# math:floating_point/ceil
#
# Get the least integer value greater than or equal of a floating point number
#> Storage
...
data modify storage io: stack_element_ref set value "io: value"
...
# Check if the fractional part is positive
...
execute if score ::math::floating_point no_zero = ::const TRUE run scoreboard players add ::math::floating_point number 1
