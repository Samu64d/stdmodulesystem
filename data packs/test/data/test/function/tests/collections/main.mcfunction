...
data modify storage io: array set value ["hello"]
data modify storage io: element set value "world"
data modify storage io: array_ref set value "io: array"
data modify storage io: element_ref set value "io: element"
...
# Clear
data modify storage io: iterable_map set value {data: {hello: {next_key:"world", value: "world"}, world: {prev_key:"hello", value: "hello"}}, last_key: "world"}
data modify storage io: iterable_map_ref set value "io: iterable_map"
...
data modify storage io: iterable_map set value {data: {hello: {next_key:"world", value: "world"}, world: {prev_key:"hello", value: "hello"}}, last_key: "world"}
data modify storage io: key set value "hello"
data modify storage io: map_ref set value "io: iterable_map"
...
data modify storage io: value set value "hello world"
data modify storage io: iterable_map_ref set value "io: iterable_map"
data modify storage io: value_ref set value "io: value"
...
data modify storage io: list set value ["hello", "world"]
data modify storage io: element set value "hello"
data modify storage io: list_ref set value "io: list"
data modify storage io: element_ref set value "io: element"
...
data modify storage io: list0 set value ["hello", "world"]
data modify storage io: list1 set value ["hello world", "hello"]
data modify storage io: list0_ref set value "io: list0"
data modify storage io: list1_ref set value "io: list1"
...
data modify storage io: element1 set value 10
data modify storage io: list_ref set value "io: list"
data modify storage io: element0_ref set value "io: element0"
data modify storage io: element1_ref set value "io: element1"
...
# Clear
data modify storage io: map set value {hello: ["world"], world: ["hello"]}
data modify storage io: map_ref set value "io: map"
...
data modify storage io: element set value "hello"
data modify storage io: set_ref set value "io: set"
data modify storage io: element_ref set value "io: element"
...
data modify storage io: stack_ref set value "io: stack"
