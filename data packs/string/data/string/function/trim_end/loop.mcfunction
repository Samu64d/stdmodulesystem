...
execute if score ::string success = ::const TRUE run function string:trim_end/remove_character

execute if score ::string success = ::const TRUE run function string:trim_end/loop
