#
# world_debug:chunk_manager/unload
#
...
execute if function minecraft_world_api:block/api/is_at_pos run function minecraft_world_api:block/api/set_air_at_pos

# Particles
function minecraft_world_api:block_pos/up
execute store result storage io: x int 1.0 run data get storage io: block_pos.x
execute store result storage io: y int 1.0 run data get storage io: block_pos.y
execute store result storage io: z int 1.0 run data get storage io: block_pos.z
function world_debug:chunk_manager/unload/show_particles with storage io:
