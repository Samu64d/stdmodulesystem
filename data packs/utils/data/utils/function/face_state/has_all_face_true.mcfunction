#
# utils:face_state/has_all_face_true
#
# Check if all face values of a face state are true
#> Storage
...
# Check matching
execute store success score ::utils::face_state success run data modify storage utils:volatile face_state.temp_face_state set from storage utils:static face_state.ALL_FACES_TRUE
