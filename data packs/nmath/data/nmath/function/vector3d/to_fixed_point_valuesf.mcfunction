#
# nmath:vector3d/to_fixed_point_valuesf
#
# Convert a double 3d vector to values with arbitrary fixed point precision
#> Scores
...
execute store result score ::out z run function math:from_storagef
