#
# minecraft_world_api:light/api/get_block_level_at_pos
#
# Get the block light level at a world position
#> Storage
...
return run function minecraft_world_api:light/api/get_block_level_at_pos/get with storage io:
