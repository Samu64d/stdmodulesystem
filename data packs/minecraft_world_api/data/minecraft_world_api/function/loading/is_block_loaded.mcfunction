#
# minecraft_world_api:loading/is_block_loaded
#
# Check if a block position is block loaded
#> Storage
...
return run function minecraft_world_api:loading/is_block_loaded/is_loaded with storage io:
