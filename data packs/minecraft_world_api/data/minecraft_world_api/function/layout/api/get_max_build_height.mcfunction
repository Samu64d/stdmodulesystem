#
# minecraft_world_api:layout/api/get_max_build_height
#
# Get the maximum build height at a world position
#> Storage
...
return run function minecraft_world_api:layout/dimension_settings_descriptor/get_max_build_height
