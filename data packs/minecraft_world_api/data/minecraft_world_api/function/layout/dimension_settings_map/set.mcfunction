...
# Set the element at the dimension settings map
data modify storage io: map_ref set value "minecraft_world_api:volatile layout.dimension_settings_map"
...
data modify storage io: value_ref set value "io: dimension_settings_descriptor"
