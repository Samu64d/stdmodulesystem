#
# minecraft_world_api:layout/heightmap/get_ocean_floor_level
#
# Get the y position of the block at the ocean floor of a chunk column
#> Storage
...
function minecraft_world_api:layout/heightmap/get_ocean_floor_level/get with storage io:
