#
# minecraft_world_api:block/api/is_at_pos
#
# Check if a block at a world position is of a block type
#> Storage
...
return run function minecraft_world_api:block/api/is_at_pos/check with storage io:
