...
data modify storage io: stack_element_ref set value "io: block_pos"
...
data modify storage io: stack_element_ref set value "io: discard"
execute if score ::inout match_success = ::const FALSE run data modify storage io: stack_element_ref set value "io: block_pos"
