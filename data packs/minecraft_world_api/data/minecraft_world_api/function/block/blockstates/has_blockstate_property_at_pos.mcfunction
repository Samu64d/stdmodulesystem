...
data modify storage io: stack_element_ref set value "io: property"
...
data modify storage io: list_ref set value "io: property_list"
data modify storage io: element_ref set value "io: property"
