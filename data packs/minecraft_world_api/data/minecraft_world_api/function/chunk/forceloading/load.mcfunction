#
# minecraft_world_api:chunk/forceloading/load
#
# Forceload a chunk, return a boolean flag indicating success or failure
#> Storage
...
return run function minecraft_world_api:chunk/forceloading/load/load with storage io:
