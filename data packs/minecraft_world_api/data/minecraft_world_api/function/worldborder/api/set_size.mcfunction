#
# minecraft_world_api:worldborder/api/set_size
#
...
execute store result score ::minecraft_world_api::worldborder result run function minecraft_world_api:worldborder/api/set_size/set with storage io:
